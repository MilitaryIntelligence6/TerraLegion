...
public class MainScreen implements Screen {
    ...
    private TextButton newWorldBtn = new TextButton("New World",
            new SpriteDrawable(ResourceManager.getInstance().getSprite("btnBg")),
            ResourceManager.getInstance().getFont("font"), Settings.getWidth() / 2 - 125, 250);
    private TextButton loadWorldBtn = new TextButton("Load World",
            new SpriteDrawable(ResourceManager.getInstance().getSprite("btnBg")),
            ResourceManager.getInstance().getFont("font"), Settings.getWidth() / 2 - 125, 175);
