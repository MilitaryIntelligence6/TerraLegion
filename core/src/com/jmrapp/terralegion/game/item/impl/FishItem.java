...
public class FishItem extends CookableItem {
    ...
    public FishItem(int typeId, int returnItem, ItemCategory category, String name, Drawable icon, int maxItemStack,
                    float useDelay, float reach) {
    ...
    public boolean onUse(World world, float touchX, float touchY) {
        ...
        for (LivingEntity entity :
                world.getChunkManager().getChunkFromPos(touchX, touchY).findLivingEntitiesInRange(touchX, touchY,
                        getReach())) {
