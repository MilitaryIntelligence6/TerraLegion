...
public class ItemStack {
    ...
    /**
     * Adds to the size of the stack. Merges two itemStacks together. This method should NOT be used to remove from
     * the itemStack
     ...
     * @return The itemStack that was used to subtract from this itemStack. Will have a stack size > 0 if there was a
     * remainder
     */
