...
public class LightBlock extends Block {
    ...
    public LightBlock(BlockType type, Drawable drawable, float lightBlockingAmount, boolean collides, float lightAmount,
    ...
    public void onBreak(ChunkManager chunkManager, Chunk chunk, int chunkTileX, int chunkTileY) {
        ...
        LightUtils.extinguishLight(chunkManager, worldX, worldY,
                lightAmount - (lightBlockingAmount - BlockManager.getBlock(BlockType.AIR).getLightBlockingAmount()),
                true);
    }
