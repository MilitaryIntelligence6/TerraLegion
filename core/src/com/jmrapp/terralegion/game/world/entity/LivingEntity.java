...
public abstract class LivingEntity extends TexturedEntity {
    ...
    public LivingEntity(Drawable drawable, float x, float y, BodyType bodyType, float speed, float maxHealth,
                        float health, float jumpVelocity) {
    ...
    public void render(SpriteBatch sb, double lightValue) {
        ...
        sb.draw(drawable.getTextureRegion(), x, y, drawable.getTextureRegion().getRegionWidth(),
