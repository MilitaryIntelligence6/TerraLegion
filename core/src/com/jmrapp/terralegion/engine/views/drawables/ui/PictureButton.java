...
public class PictureButton extends Button {
    ...
    public PictureButton(Drawable drawable, float x, float y, float offsetBtnX, float offsetBtnY, float width,
                         float height) {
    ...
    public boolean isPressed(float xClick, float yClick) {
        return new Rectangle(x + offsetBtnX, y + offsetBtnY, width, height).overlaps(new Rectangle(xClick, yClick, 1,
                1));
    }
